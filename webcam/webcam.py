...
josh_image = face_recognition.load_image_file("Josh.jpeg")
josh_face_encoding = face_recognition.face_encodings(josh_image, model="small")[0]
...
while True:
    ...
    if process_this_frame:
        ...
        boxes = face_recognition.face_locations(rgb_small_frame)  # must be list of tuples
        assert isinstance(boxes, list)
        assert all(isinstance(b, tuple) and len(b) == 4 for b in boxes)
